...
if test -e "$A"; then
	cd ~/code/pmbootstrap
else mkdir -p ~/code && cd code && git clone https://gitlab.com/postmarketOS/pmbootstrap && pmbootstrap chroot -- apk upgrade && pmbootstrap chroot -- apk add abootimg android-tools mkbootimg dtbtool
fi
